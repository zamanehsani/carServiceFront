            ...
            <div className="container mx-auto">
                <div className="flex items-center justify-between p-4">
                    ...
                    <div className="hidden lg:flex items-center space-x-6">
                        <Link to={'/'} className="text-xl text-white mx-4 hover:text-gray-300 ">{t("header.home")}</Link>
                        <Link to={'/add-deal'} className="text-xl text-white mx-4 hover:text-gray-300 ">{t("header.add-deal")}</Link>
                        ...
                        <div className="relative">
                            ...
                            <div ref={langRef} className="absolute left-1/2 z-10 mt-6 flex w-screen max-w-max -translate-x-1/2 px-4">
                                <div className=" max-w-md flex-auto overflow-hidden rounded-lg bg-white text-sm leading-6 shadow-lg">
                                    <div onClick={()=>handleLanguageChange('en','ltr')} className="px-8 py-3 group relative rounded-lg hover:bg-gray-50 cursor-pointer">
                                        <span  className="font-semibold text-indigo-600"> Enlish </span>
                                    </div>
                                    <div onClick={()=>handleLanguageChange('ar','rtl')}  className="px-8 py-3 group relative rounded-lg hover:bg-gray-50">
                                        <span  className="font-semibold text-indigo-600"> العربية </span>
                                    </div>
                                    <div onClick={()=>handleLanguageChange('fr','rtl')} className="px-8 py-3 group relative rounded-lg hover:bg-gray-50">
